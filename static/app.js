...
const Footer = () => (
    <footer className="bg-gray-100 p-6 py-4 text-center text-sm text-gray-600 border-t border-gray-200">
        <p className="flex items-center justify-center">
            <span>Built by</span>
            <a href="https://github.com/ZubairAhmad97/Customer-Support-Chatbot.git" target="_blank" className="text-indigo-600 hover:text-indigo-800 px-1">ZUBAIR AHMAD</a>
            2025 
            <span className="text-gray-400 px-2">|</span>
            <a href="https://github.com/ZubairAhmad97/Customer-Support-Chatbot.git" 
                target="_blank" 
